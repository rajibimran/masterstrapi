...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    centerText: Schema.Attribute.RichText & Schema.Attribute.Required;
    centerTitle: Schema.Attribute.String & Schema.Attribute.Required;
    chairmanMessageText: Schema.Attribute.RichText;
    chairmanMessageTitle: Schema.Attribute.String;
    chairmanPhoto: Schema.Attribute.Media<'images'>;
    corporateProfileText: Schema.Attribute.RichText;
    corporateProfileTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facilityGallerySubtitle: Schema.Attribute.Text;
    facilityGalleryTitle: Schema.Attribute.String;
    gallery: Schema.Attribute.Component<'about.gallery-item', true>;
    historyText: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    managingDirectorMessageText: Schema.Attribute.RichText;
    managingDirectorMessageTitle: Schema.Attribute.String;
    managingDirectorPhoto: Schema.Attribute.Media<'images'>;
    missionImage: Schema.Attribute.Media<'images'>;
    missionText: Schema.Attribute.RichText & Schema.Attribute.Required;
    missionTitle: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.entry', false>;
    timeline: Schema.Attribute.Component<'about.timeline-item', true>;
...
export interface ApiCertificationCertification
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentFile: Schema.Attribute.Media<'files'>;
...
export interface ApiCountryGuidelineCountryGuideline
  ...
  attributes: {
    ...
    guideline: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.entry', false>;
    slug: Schema.Attribute.UID<'countryName'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFitnessCriterionFitnessCriterion
  extends Struct.CollectionTypeSchema {
  collectionName: 'fitness_criteria';
  info: {
    displayName: 'Fitness Criterion';
...
export interface ApiFooterServiceLinkFooterServiceLink
  extends Struct.CollectionTypeSchema {
...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctas: Schema.Attribute.Component<'hero.cta-button', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    documents: Schema.Attribute.Component<'service.document-item', true>;
    featuredImage: Schema.Attribute.Media<'images'>;
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    pricingRows: Schema.Attribute.Component<'service.pricing-row', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.entry', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    summary: Schema.Attribute.Text;
    timeline: Schema.Attribute.Component<'service.timeline-step', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
